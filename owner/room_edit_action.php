...
$query="UPDATE add_room SET room_no='$room_no',room_sell='$type',manage='$manage',manage_name='$manage_name',manage_no='$manage_no',room_address='$room_address',room_state='$room_state',room_district='$room_district',room_city='$room_city',room_description='$room_description',room_bed='$room_bed',room_bathroom='$room_bathroom',room_kitchen='$room_kitchen',room_furnishing='$room_furnishing',room_wifi='$room_wifi',room_img='$room_img',room_vid='$room_vid',room_price='$room_price' WHERE room_no='$id' ";
